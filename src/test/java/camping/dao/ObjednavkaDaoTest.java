...
public class ObjednavkaDaoTest {
    ...
    public ObjednavkaDaoTest() {
        dao = DaoFactory.INSTANCE.getObjednavkaDao();
    }
    ...
    public void createTest() {
        ...
        objednavka.setId(1L);
        objednavka.setDatumObjednavky(LocalDateTime.MIN);
        objednavka.setDatumPrichodu(LocalDateTime.MIN);
        objednavka.setDatumOdchodu(LocalDateTime.MIN);
    ...
    // mazanie objednávky - podla coho bude mazaná (?)
    @Test
    public void deleteTest() {
        int velkost = dao.getAll().size();
        Objednavka objednavka = dao.getAll().get(0);
        dao.deleteObjednavku(objednavka);
        assertEquals(velkost - 1 , dao.getAll().size());
    }
